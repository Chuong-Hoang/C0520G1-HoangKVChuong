...
public class Constant {
    ...
    public static final String STR_A = "Phone_Number";
    public static final String STR_B = "Group";
    public static final String STR_C = "Full_Name";
    public static final String STR_D = "Gender";
    public static final String STR_E = "Address";;
    public static final String STR_E1 = "Birthday";
    public static final String STR_E2 = "Email";
    public static final String INPUT = ": Input as below -->";
    public static final String RE_INPUT = ": Input New Information -->";
    public static final String UPDATE = ".Update ";

    // File paths
    public static final String FILE_PATH = "src/final_exam/Contact.csv";
