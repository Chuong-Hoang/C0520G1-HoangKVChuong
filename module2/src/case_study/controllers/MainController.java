    ...
    private static void addNewServices() {
        ...
        switch (option) {
            ...
            case 2:
                ...
                ReaderAndWriter.writeServiceFile(houseManager.getHouseObjectList(), HOUSE_FILE_PATH);
            ...
            case 3:
                ...
                ReaderAndWriter.writeServiceFile(roomManager.getRoomObjectList(), ROOM_FILE_PATH);
