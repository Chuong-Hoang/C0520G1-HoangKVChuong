...
public class User implements Validator {
    ...
    private int id;
    @NotEmpty
    @Size(min = 2, max = 30, message = "Not valid! name length must at least 2 and max 30 characters.")
    private String name;
    @Range(min = 18, message = "Not valid! age must at least 18.")
    private int age;
