...
import vn.codegym.chuong.service.security_service.UserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable();
//        http .logout().logoutUrl("/logout").logoutSuccessUrl("/out").permitAll();
        http
                .formLogin()
                .loginPage("/login")
                ...
                .and()
                .authorizeRequests().antMatchers("/employee/**").hasAnyRole("ADMIN", "MASTER")
