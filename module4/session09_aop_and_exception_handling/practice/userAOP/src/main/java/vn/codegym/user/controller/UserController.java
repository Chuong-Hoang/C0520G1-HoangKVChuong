package vn.codegym.user.controller;
...
import vn.codegym.user.service.UserService;
...
public class UserController {
    ...
    @PostMapping("/create")
    public ModelAndView getCreated(@Validated @ModelAttribute User user, BindingResult bindingResult) throws DuplicateEmailException {
    ...
    @PostMapping("/edit")
    public ModelAndView getEdited(@Validated @ModelAttribute User user, BindingResult bindingResult) throws DuplicateEmailException {
        new User().validate(user, bindingResult);
        if(bindingResult.hasFieldErrors()){
