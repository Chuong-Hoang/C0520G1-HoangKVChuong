...
public class ElementDAOImplement implements ElementDAO {
    ...
    static {
        ...
        elements.put(1, new Element(1, "P_1", "1000", "...", "A"));
        elements.put(2, new Element(2, "P_2", "1200", "...", "B"));
        elements.put(3, new Element(3, "P_3", "1400", "...", "C"));
        elements.put(4, new Element(4, "P_4", "1600", "...", "D"));
        elements.put(5, new Element(5, "P_5", "1800", "...", "E"));
    }
