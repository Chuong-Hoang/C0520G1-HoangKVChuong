...
<table>
    ...
    <c:forEach items="${eList}" var="el">
        <tr>
            ...
            <td>${el.divisionId}</td>
            <td><a href="${originalLink}?action=edit&id=${el.employeeId}">Edit</a></td>
            <td><a href="${originalLink}?action=delete&id=${el.employeeId}">Delete</a></td>
            <td><a href="${originalLink}?action=view&id=${el.employeeId}">View</a></td>
        </tr>
    </c:forEach>
</table>
</center>
