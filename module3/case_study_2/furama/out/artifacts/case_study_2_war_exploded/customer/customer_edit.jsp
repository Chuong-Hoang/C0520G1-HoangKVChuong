        ...
        <fieldset>${element_name.toUpperCase()} INFORMATION
            <table class="table table-striped table-hover" style="width: 25%">
                <tr>
                    ...
                    <td scope="col"><input type="text" name="idNew" id="idNew" value="${el.customerId}"><span class="msg-invalid">(*)</span><br>
                        <span class="msg-invalid">${msg_invalid_id}</span></td></td>
                </tr>
                <tr>
                    <td scope="col">${title_a}</td>
                    <td scope="col"><input type="text" name="a" id="a" value="${el.customerName}"><span class="msg-invalid">(*)</span><br>
                        <span class="msg-invalid">${msg_invalid_a}</span></td>
                </tr>
                <tr>
                    <td scope="col">${title_b}</td>
                    <td scope="col"><input type="date" name="b" id="b" value="${el.customerBirthday}"><span class="msg-invalid">(*)</span><br>
                ...
                <tr>
                    ...
                    <td scope="col"><input type="text" name="d" id="d" value="${el.customerIdCard}"><span class="msg-invalid">(*)</span><br>
                        <span class="msg-invalid">${msg_invalid_d}</span></td>
                </tr>
                <tr>
                    <td scope="col">${title_e}</td>
                    <td scope="col"><input type="text" name="e" id="e" value="${el.customerPhone}"><span class="msg-invalid">(*)</span><br>
                        <span class="msg-invalid">${msg_invalid_e}</span></td>
                </tr>
                <tr>
                    <td scope="col">${title_f}</td>
                    <td scope="col"><input type="text" name="f" id="f" value="${el.customerEmail}"><span class="msg-invalid">(*)</span><br>
