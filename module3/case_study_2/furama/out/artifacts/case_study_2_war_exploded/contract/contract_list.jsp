...
<table id="pagination" class="table table-striped table-hover">
    ...
    <c:forEach items="${eList}" var="el">
        <tr id="${el.contractId}">
            ...
            <td scope="col">
                <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#e${el.contractId}">
                    Delete
                </button>
                <!-- Modal -->
                <div class="modal fade" id="e${el.contractId}" tabindex="-1" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
