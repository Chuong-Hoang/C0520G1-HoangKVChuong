        ...
        <fieldset>${element_name.toUpperCase()} INFORMATION
            <table class="table table-striped table-hover" style="width: 25%">
                <tr>
                    ...
                    <td scope="col"><input type="text" name="idNew" id="idNew" value="${el.contractId}"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td scope="col"><input type="text" name="e" id="e" value="${el.contractEmployeeId}"></td>
                </tr>
                <tr>
                    <td scope="col">${title_f}</td>
                    <td scope="col"><input type="text" name="f" id="f" value="${el.contractCustomerId}"></td>
                </tr>
                <tr>
                    <td scope="col">${title_g}</td>
                    <td scope="col"><input type="text" name="g" id="g" value="${el.contractServiceId}"></td>
                </tr>
